...
SPEECH_TO_TEXT_APIKEY = os.getenv("SPEECH_TO_TEXT_APIKEY", "")
SPEECH_TO_TEXT_IAM_APIKEY = os.getenv("SPEECH_TO_TEXT_IAM_APIKEY", "")
SPEECH_TO_TEXT_URL = os.getenv("SPEECH_TO_TEXT_URL", "")
SPEECH_TO_TEXT_AUTH_TYPE = os.getenv("SPEECH_TO_TEXT_AUTH_TYPE", "")
